...
Utils = loadfile(scriptsPath .. "Utils.lua")
Utils()
Constants = loadfile(scriptsPath .. "Constants.lua")
Constants()
Display = loadfile(scriptsPath .. "Display.lua")
Display()
Item = loadfile(scriptsPath .. "Item Data.lua")
Item()
Spell = loadfile(scriptsPath .. "Spell Data.lua")
Spell()
Actor = loadfile(scriptsPath .. "Actor Data.lua")
Actor()
Battle = loadfile(scriptsPath .. "Battle Data.lua")
Battle()
Field = loadfile(scriptsPath .. "Field Data.lua")
Field()
Menu = loadfile(scriptsPath .. "Menu Data.lua")
Menu()
Program = loadfile(scriptsPath .. "Program Data.lua")
Program()
UI = loadfile(scriptsPath .. "UI.lua")
UI()
Input = loadfile(scriptsPath .. "Input.lua")
Input()
